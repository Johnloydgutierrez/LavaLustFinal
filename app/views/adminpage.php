...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/Sales" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Sale Management</a>
    ...
    <div class="bg-light rounded-top p-4 text-center"> <!-- Added text-center class -->
        <div class="row">
            <div class="col-12 col-sm-6 mx-auto"> <!-- Added mx-auto class for horizontal centering -->
                <img src="../public/images/nwow.png" alt="" class="mx-auto d-block"> <!-- Center the image using mx-auto and d-block classes -->
                <br>
    ...
    <script src=<?=site_url("https://code.jquery.com/jquery-3.4.1.min.js")?>></script>
